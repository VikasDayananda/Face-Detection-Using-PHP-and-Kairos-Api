...
<div class="login">
    <h1>Login</h1>
    <form name="form_details" method="post" action="index.php">
        <input type="text" name="userid" placeholder="Agent name" required="required"/>
        <input type="password" name="password" placeholder="Agent key" required="required"/>
        <button type="submit" name="signin" class="btn btn-primary btn-block btn-large">Let me in</button>
